...
const About = () => {
  return (
    <>
      <div id="about" className="min-w-screen min-h-screen bg-green-500 flex items-center p-5 lg:p-10 overflow-hidden relative">
            ...
            <div className="w-full md:w-1/2 px-20 mb-10 md:mb-0">
              ...
              <div className="relative">
                <img
                  ...
                  alt="profile picture"
                />
               <div className="border-4 border-blue-400 absolute top-28 bottom-28 left-28 right-28 z-0"></div> 
              </div>
            </div>
            <div className="w-full md:w-1/2 px-10">
              ...
              <div>
                ...
                <div className="inline-block align-bottom">
                  <button className="bg-blue-300 opacity-75 hover:opacity-100 text-blue-900 hover:text-blue-900 rounded-full px-10 py-2 font-semibold">
                    <i className="mdi mdi-cart -ml-2 mr-2"></i> PROJECTS
                  </button>
                </div>
                <div className="inline-block align-bottom">
                  <button className="bg-blue-300 opacity-75 hover:opacity-100 text-blue-900 hover:text-blue-900 rounded-full px-10 py-2 font-semibold">
                    <i className="mdi mdi-cart -ml-2 mr-2"></i> RESUME
                  </button>
                </div>
              </div>
            </div>
